...
<%if (options.customClientIntegrationsPlugin) {%>import getCustomIntegrations from '<%= options.customClientIntegrationsPlugin %>'<%}%>
...
export default async function (ctx, inject) {
  ...
  <% } %>
  <% if (options.customClientIntegrationsPlugin) { %>
